...
class EvolveViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let shapes = generatePolygons()
        let imageData = getPixelData(image: UIImage(named: "mona")!, width: imageSize, height: imageSize)
        mutate(shapes: shapes, imageData: imageData)
    }
